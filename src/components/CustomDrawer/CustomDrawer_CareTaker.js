...
const CustomDrawer_CareTaker = (props) => {

    const route = useRoute();
    const dispatch = useDispatch();
    const USER_NAME = useSelector((state) => state.auth.userName);
    let USER_DESIGNATION = useSelector((state) => state.auth.userType);
                ...
                <DrawerContentScrollView {...props}>
                    <View style={styles.userInfo}>
                        ...
                        <View style={styles.userInfo_nameContainer}>
                            <Text numberOfLines={1} style={styles.userInfo_name}>{USER_NAME ? USER_NAME : ''}</Text>
                    ...
                    <DrawerItem
                        label="Complaints"
                        iconFamily="MaterialCommunityIcons"
                        iconName="message-alert-outline" size={22}
                        name='manage_data'
                        activeRoute={routeName}
                        handlePress={() => handlePress('complain')}
                    />
                    <DrawerItem
                        label="About"
                        iconFamily="MaterialCommunityIcons"
...
export default CustomDrawer_CareTaker;