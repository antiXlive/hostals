        ...
        <View style={styles.card}>
            <View style={{width:'65%'}}>
                <View style={{height:'75%'}}>
                    ...
                    <Text style={styles.greetBox_Text2}>{userName.substr(0,9)}</Text>
                </View>
                <View style={{height:'25%',flexDirection:'row',alignItems:'center',paddingLeft:'5%', paddingBottom:'5%'}}>
                    <View style={{width:6,height:6,backgroundColor:constants.M1,borderRadius:20, marginRight:WIDTH*0.02}}></View>
                    <Text style={{fontSize:12, fontWeight:'700',opacity:0.5}}>{splittedDate[0].toUpperCase()}, {new Date().getDate()} {splittedDate[1].toUpperCase()}  {showTime()}</Text>
                </View>
            </View>
            <View style={{width:'35%'}}>
